...
<!-- ================================
     ...
     ================================ -->
<section class="min-h-[75vh] flex items-center px-5 pt-8 pb-16 text-center bg-[radial-gradient(1200px_400px_at_50%_0%,#eef2ff_0%,#f8fafc_55%,#f8fafc_100%)] dark:bg-[radial-gradient(1200px_400px_at_50%_0%,#1e293b_0%,#0f172a_55%,#0f172a_100%)]">
    <div class="w-full">
        <div class="max-w-[720px] mx-auto bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-[20px] px-6 py-7 sm:px-12 sm:py-10 shadow-[0_20px_40px_rgba(15,23,42,0.08)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.3)] anim-slide delay-1 hover:shadow-[0_28px_50px_rgba(15,23,42,0.12)] dark:hover:shadow-[0_28px_50px_rgba(0,0,0,0.4)] hover:-translate-y-1 transition-all duration-300">
            <!-- Page heading — fades in first -->
            <h1 class="text-[2.1rem] sm:text-[2.6rem] font-bold text-slate-900 dark:text-white mb-3 anim-fade">Efficient Lab Management</h1>
            <!-- Short description — fades in slightly after the heading -->
            <p class="text-[1.05rem] text-slate-500 dark:text-slate-400 max-w-[560px] mx-auto mb-7 leading-6 anim-fade delay-1">Track your laboratory hours, view available slots, and manage your sit-in sessions with the unofficial CCS Monitoring System.</p>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center anim-fade delay-2">
                ...
                <a href="register.php" class="px-8 py-3 rounded-lg font-semibold border-2 border-[#003366] text-[#003366] dark:text-white dark:border-blue-400 hover:bg-slate-100 dark:hover:bg-slate-700 transition">Create Account</a>
            </div>
        </div>
    </div>
</section>
