...
<nav class="bg-[#003366] text-white shadow-lg sticky top-0 z-50">
    <div class="px-[5%] py-4">
        ...
        <div class="flex gap-2 flex-wrap">
            ...
            <a href="admin_dashboard.php" class="px-3 py-2 text-sm font-semibold bg-white/20 rounded hover:bg-white/30 transition border-b-2 border-white">Record Sit-in</a>
